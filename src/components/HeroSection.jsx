  ...
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="text-center z-10 px-4 flex flex-col justify-center gap-4">
        ...
        <div className="flex flex-col lg:flex-row gap-4 z-10 justify-center lg:w-full w-2/3 mx-auto">
      ...
      <div className="absolute bottom-22 grid grid-cols-3 items-center mx-4 w-full max-w-md">
        ...
        <div className="flex justify-around">
          ...
          >
            <Facebook className="w-8 h-8 text-white cursor-pointer hover:text-slate-300" />
          </a>
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <FaWhatsapp className="w-8 h-8 text-white cursor-pointer hover:text-slate-300" />
          </a>
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <Instagram className="w-8 h-8 text-white cursor-pointer hover:text-slate-300" />
          </a>
        </div>
