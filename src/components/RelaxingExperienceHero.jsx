    ...
    >
      ...
      <div
        className="relative z-10 max-w-2xl px-6 py-12 ml-auto lg:me-4 space-y-4
             bg-[#00000009] bg-opacity-20 backdrop-blur-xl rounded-md
             "
      >
        <div>
          ...
          <div className="flex space-x-1">
            {[...Array(5)].map((_, index) => (
              <Star key={index} className="fill-black text-black w-5 h-5" />
            ))}
          </div>
        </div>
        ...
        <button className="bg-black hover:bg-gray-950 px-6 py-3 rounded-md font-semibold cursor-pointer">
